...
// const result1 = nums.reduce((final, eachNum) => {
//   final = final + eachNum;
//   return final;
// }, 0); //final starts at 0);
...
const result2 = users.reduce((final, eachUser) => {
  final.push(eachUser.fName + '' + eachUser.lName);
  return final;
}, []);
...
// const result3 = voters.reduce((final, eachVoter) => {
//   eachVoter.voted && final++;
//   return final;
// }, 0);
...
// Return an object that has a count of both who voted and who didnt
const result4 = voters.reduce(
  (final, eachVoter) => {
    eachVoter.voted ? final.voted++ : final.didntVote++;
    return final;
  },
  { voted: 0, didntVote: 0 }
);
